...
public class BookServiceImpl implements BookService{
    ...
    @Override
    public String addBook(Book book, Integer quantity) throws InvalidQuantity, BookAlreadyPresent {
    ...
    @Override
    public synchronized BookQuantity updateQuantity(String id, Integer quantity) throws InvalidQuantity, OutOfStockException, BookNotFound {
        if(quantity < 0){
            throw new InvalidQuantity("Quantity should be positive.");
        }
